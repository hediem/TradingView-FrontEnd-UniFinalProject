...
const Details = ({ symbol }) => {
    ...
    return (
        <div
            className="card d-flex flex-row py-3 mb-2 row align-items-center"
            style={{
        ...
        >
            ...
            <div className="d-flex flex-column ms-3 col-7">
                <div style={{ fontSize: "14px", fontWeight: "500" }}>{symbol.name}</div>
                <div
            ...
            <div className="col-12 d-flex justify-content-end" style={{ position: "relative", top: "-5px" }}>
                <div
                    style={{
                        cursor: "pointer",
                        backgroundColor: "#F0F2F5",
