...
const SideBar = () => {
    ...
    return (
        ...
        >
            ...
            <div
                className="card d-flex py-3 col-12 col-lg-11"
                style={{
            ...
            >
                <div
                    ...
                    style={{ cursor: "pointer", color: showArrow && temp === 1 ? "#227AEF" : "" }}
                >
                    <div>OverView</div>
                ...
                <div
                    ...
                    style={{ cursor: "pointer", color: showArrow && temp === 2 ? "#227AEF" : "" }}
                >
                    <div>Profile</div>
                ...
                <div
                    ...
                    style={{ cursor: "pointer", color: showArrow && temp === 3 ? "#227AEF" : "" }}
                >
